...
const Reserve = ({setOpen, hotelId}) => {
    ...
    const getDatesRange = (start, end)=> {                            // to get date range
    ...
    const isAvailable = (roomNumber) => {                                           //to find date is available or not
   ...
   const handleClick = async ()=>{
     try {
      ...
      setOpen(false)
      navigate("/")                                        //we can create a new payment page and redirect there
